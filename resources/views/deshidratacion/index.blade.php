...
function exportF(elem) {
  ...
  elem.setAttribute("download", "Porcentajes_deshidratacion.xls"); // Choose the file name
  return false;
}
</script>
...
<div class="container">
      <div class="row justify-content-left">
        <div class="col-md-3">
			...
			<a href="{{url('/deshidratacion/create')}}" class="btn btn-success" >Agregar nuevo Parámetro</a>
        ...
        <div class="col-md-12">
		    ...
		    <div style="overflow-x:auto;">      
		     <table class="table table-light table-striped table-bordered" id="example"  style="width:100%">
			    ...
			    <tbody>
				 @foreach($deshidratacion as $producto)
				  <tr>
				   ...
				   <td>{{$producto->porcentaje}}</td>
					...
					<td>
					 	<div class="btn-group">
					 	 ...
					 	 <form class="btn-group" method="post" action="{{url('deshidratacion/'.$producto->id)}}">
					 	 	<a href="{{url('/deshidratacion/'.$producto->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true" ></i></a>
					 		{{csrf_field()}}
					 		{{method_field('DELETE')}}
