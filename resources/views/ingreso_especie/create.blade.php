...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Ingreso de Especie</div>
                   <div class="col-md-12">
               	
            		  <form action="{{url('/ingreso_especie')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                          ...
                          <div class="input-group mb-3">
                            ...
                            <div class="col-md-4">
                            <span><input type="text"  onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="especie" id="especie" value="">
                            </span>
                            </div>
