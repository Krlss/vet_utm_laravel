<div>
    ...
    <div class="grid grid-cols-1">
        ...
        <div class="flex flex-col px-2 md:mb-0 mb-2">
            ...
            {!! Form::text('name', $fur->name, ['class' => 'form-control border-1 border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-300 focus:border-transparent rounded-sm', 'placeholder' => trans('lang.name'), 'required' => true]) !!}
            @error('name')
