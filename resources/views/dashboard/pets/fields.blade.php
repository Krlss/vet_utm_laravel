<div>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div class="flex flex-col px-2">
            ...
            <div class="">
                {!! Form::text('specie', old('specie'), ['class' => 'form-control border-1 border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-300 focus:border-transparent rounded-sm', 'placeholder' => trans('lang.last_name1'), 'required' => true]) !!}
                <div class="text-gray-500 text-sm mb-2">
                    {{ trans('lang.required') }}
                </div>
            </div>
