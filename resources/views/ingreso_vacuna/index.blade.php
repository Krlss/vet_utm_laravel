...
<div class="container">
      <div class="row justify-content-left">
        <div class="col-md-3">
            ...
            <a href="{{url('/ingreso_vacuna/create')}}" class="btn btn-success" >Agregar nuevas Vacunas</a>
        ...
        <div class="col-md-12">
            ...
            <div style="overflow-x:auto;">      
             <table class="table table-light table-striped table-bordered" id="example"  style="width:100%">
                ...
                <tbody>
                 @foreach($vacuna as $producto)
                  <tr>
                    <td>{{$loop->iteration}}</td>
                    <td>{{$producto->especie}}</td>
                    <td>{{$producto->nom_vacuna}}</td>
                    <td>
                        <div class="btn-group">
                         <form class="btn-group" method="post" action="{{url('ingreso_vacuna/'.$producto->id)}}">
                            <a href="{{url('/ingreso_vacuna/'.$producto->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-pencil" ></i></a>
                            {{csrf_field()}}
                            {{method_field('DELETE')}}
