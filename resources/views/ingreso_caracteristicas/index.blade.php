...
function exportF(elem) {
  ...
  elem.setAttribute("download", "Caracteristicas.xls"); // Choose the file name
  return false;
}
</script>
...
<div class="container">
      <div class="row justify-content-left">
        <div class="col-md-3">
			...
			<a href="{{url('/ingreso_caracteristicas/create')}}" class="btn btn-success" >Agregar nuevo Parámetro</a>
				 ...
				 @foreach($deshidratacion as $producto)
				  <tr>
				   ...
				   <td>{{$producto->porcentaje}}</td>
					...
					<td>
					 	<div class="btn-group">
		            	<a href="{{url('/ingreso_caracteristicas/'.$producto->id.'/edit')}}" class="btn btn-warning"><i class="fa fa-pencil" ></i></a>
					  		

					 	 <form method="post" action="{{url('ingreso_caracteristicas/'.$producto->id)}}">
					 		{{csrf_field()}}
					 		{{method_field('DELETE')}}
