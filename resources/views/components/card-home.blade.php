<div class="w-full md:max-w-xs max-w-none">
    <!-- small box -->
    <a href="{{route($route)}}">
        <div class="group p-2.5 text-{{$color}} bg-{{$bg}}-500 rounded-sm relative block shadow-sm">
            ...
            <div class="z-0 text-black opacity-20 md:block hidden group-hover:opacity-30">
