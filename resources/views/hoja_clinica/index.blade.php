...
<script type="text/javascript">
   function exportF(elem) {
     ...
     elem.setAttribute("download", "Grupos.xls"); // Choose the file name
     return false;
   }
...
<div class="" style="width:10%">
      ...
      <div class="">
       <a href="{{url('/home')}}" class="btn btn-process w3-button w3-hover-yellow" ><img src="https://img.icons8.com/pastel-glyph/64/26e07f/back.png" height="40">Atras</a>
      </div>
     </div>
<div class="container">
      <div class="row justify-content-left">
	    <div class="col-md-3">
                <h4>Historias Clínicas Generadas</h4>
                <!--
	            <div class="card"> 
				  <a href="{{url('/hoja_clinica/show')}}" class="btn btn-success" >Nueva Historia Clinica</a>
	            </div> 
                -->
	   	</div>
   	   </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{$pet->id_pet_mother}}</td>
            ...
            <td>
                <div  class="btn-group">
                    <form class="btn-group" method="post" action="{{url('/hoja_clinica/'.$pet->cod_mascota)}}">
                        <a title="Reporte de historia clinica" href="{{url('/hoja_clinica/show/'.$pet->cod_mascota)}}" class="btn btn-warning" target ="_blank"><i class="fa fa-file-pdf-o" ></i></a>
                        {{csrf_field()}}
                        {{method_field('DELETE')}}
                        
                        <a title="Generar historia clinica" href="{{url('/hoja_clinica/create/'.$pet->cod_mascota)}}" class="btn btn-success"><i class="fa fa-book" aria-hidden="true"></i></a>
