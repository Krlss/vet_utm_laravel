...
<form action="{{url('/plan_terapeutico/create/'.$pet->cod_mascota.'/')}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
<div align="center">
 <table class="table table-light">
      <thead class="table">
       <tr>
        <td class="w3-border" style="width:30%">Fecha:<input disabled type="text" id="fecha_generado" style="width:70%; text-align:center;" value="{{$pet->birth}}" ></td>
        ...
        <td class="w3-border" style="width:35%"># H. Clínica: <input disabled type="text"name="num_historia" id="num_historia" style="width:70%; text-align:center;" value="{{$pet->cod_mascota}}" ></td>
       </tr>
      </thead>
 </table>
</div>
...
<table class="table table-light" id="dynamic_field">
  <thead class="table-success">
    <tr>
       ...
       <th class="w3-border" style="width:10%">Dosis(mg)</th>
  ...
  <tbody>
    <tr >
      <tr> 
        ...
        <td class="w3-border">
           <label>  
        <input type="number" name="moreFields[0][dosis_cant]" id="dosis_cant" class="inputText form-control" > 
        </label>
        </td>
        <td class="w3-border">
           <label>  
        <input type="number" name="moreFields[0][dosis_tiempo]" id="dosis_tiempo" class="inputText form-control" > 
        </label>
        </td>
        <td class="w3-border">
           <label>  
        <input type="number" name="moreFields[0][dosis_administra]" id="dosis_administra" class="inputText form-control" > 
        </label>
        </td>
        <td class="w3-border">
           <span>
        ...
        <td class="w3-border ">
            <input class="form-control" type="textarea" name="moreFields[0][frec_duracion]" id="frec_duracion" value="" style="width:100%">
        </td>
...
i++;  
$('#dynamic_field').append('<tr id="row'+i+'" class="dynamic-added"><td class="w3-border"><span><select class="form-control" name="moreFields[0][tipo_terapia]"  id="tipo_terapia"  value=""><option value="0">TS</option><option value="1">P</option><option value="2">S</option><option value="3">E</option></select></span></td><td class="w3-border"><span><select class="form-control" name="moreFields[0][principio_activo]"  id="principio_activo"  value=""><option value="0">Natural</option><option value="1">Quimico</option></select></span>   </td><td class="w3-border"><span><select class="form-control" name="moreFields[0][presentacion]"  id="presentacion"  value=""><option value="0">Tableta</option><option value="1">Suspension</option><option value="2">Ampolla</option></select></span></td><td class="w3-border"><label><input type="number" name="moreFields[0][dosis_cant]"id="dosis_cant" class="inputText form-control"></label>        </td><td class="w3-border"><label><input type="number" name="moreFields[0][dosis_tiempo]" id="dosis_tiempo" class="inputText form-control"></label>    </td><td class="w3-border"><label><input type="number" name="moreFields[0][dosis_administra]" id="dosis_administra" class="inputText form-control">     </label></td><td class="w3-border"><span><select class="form-control" name="moreFields[0][via]"  id="via"  value=""><option value="0">Oral</option><option value="1">Sub-cutanea</option><option value="2">Intramuscular</option><option value="2">Rectal</option>          </select></span></td><td class="w3-border"><input class="form-control" type="textarea" name="moreFields[0][frec_duracion]" id="frec_duracion" value="" style="width:100%"></td><td class="w3-border "><button type="button" name="remove" id="'+i+'" class="btn btn-danger form-control btn_remove">X</button></td></tr>');  
});  
