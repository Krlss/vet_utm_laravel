...
// alert(document.getElementById("patron_distribucion").value);
}
</script>
...
<div align="center">
    @foreach($mascota as $pet)
        <input disabled type="text" id="sexo" style="width:70%; text-align:center;" hidden="true" value="{{$pet->sex}}" >
        @endforeach
 <table class="table table-light">
    @foreach($hoja_clinica as $hoja)
      ...
      <thead class="table">
       <tr>
        <td class="w3-border" style="width:30%">Fecha:<input disabled type="text" id="fecha_generado" style="width:70%; text-align:center;" value="{{$hoja->fecha_consulta}}" ></td>
      

        <td class="w3-border" style="width:35%"># H. Clínica: <input disabled type="text"name="cod_mascota" id="cod_mascota" style="width:70%; text-align:center;" value="{{$hoja->cod_mascota}}" ></td>
       </tr>
       @endforeach
      </thead>
 </table>
   ...
   <div>
    ...
    <tr>
       ...
       <td class="w3-border">
         <div class="col" style="background-color:#FFFFFF;">
         <label>  
            Si: <input type='radio' name='radio_m' value='SI' id="g1" onclick='Pluss()'>   
         </label>
         <label>  
            No: <input type='radio' name='radio_m' value='NO' id="g1" onclick='Pluss()'>   
         </label>
         </div>
       </td>
    ...
    <tr>
       ...
       <td class="w3-border">
         <div class="col" style="background-color:#FFFFFF;">
         <label>  
            Si: <input type='radio' name='radio_e' value='SI' id="g2" onclick='Pluss()'>   
         </label>
         <label>  
            No: <input type='radio' name='radio_e' value='NO' id="g2" onclick='Pluss()'>   
         </label>
         </div>
       </td>
    ...
    <tr>
       ...
       <td class="w3-border">
         <div class="col" style="background-color:#FFFFFF;">
         <label>  
            Si: <input type='radio' name='radio_i' value='SI' id="g3" onclick='Pluss()'>   
         </label>
         <label>  
            No: <input type='radio' name='radio_i' value='NO' id="g3" onclick='Pluss()'>   
         </label>
         </div>
       </td>
